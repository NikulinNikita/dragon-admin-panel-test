 ...
 *
 * @method static \Admin\Form\Element\SmartText sText($name, $label = null)
 * @method static \Admin\Form\Element\SmartImage sImage($name, $label = null)
 * @method static \Admin\Form\Element\SmartDate sDate($name, $label = null)
 * @method static \Admin\Form\Element\SmartDateTime sDateTime($name, $label = null)
 * @method static \Admin\Form\Element\SmartPassword sPassword($name, $label = null)
 * @method static \Admin\Form\Element\SmartMultiSelect sMultiSelect($name, $label = null, $options = [])
 * @method static \Admin\Form\Element\SmartSelect sSelect($name, $label = null, $options = [])
 * @method static \Admin\Form\Element\SmartDepSelect sDepSelect($name, $label = null, array $depends = [], Model $parentModel = null)
 * @method static \Admin\Form\Element\SmartCheckbox sCheckbox($name, $label = null)
 * @method static \Admin\Form\Element\SmartCKEditor sCKEditor($name, $label = null)
 * @method static \Admin\Form\Element\SmartTextArea sTextArea($name, $label = null)
 * @method static \Admin\Form\Element\SmartRadio sRadio($name, $label = null)
 * @method static \Admin\Form\Element\SmartNumber sNumber($name, $label = null)
 */
