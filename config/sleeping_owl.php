...
return [
    ...
    */
     ...
     */
    'env_editor_middlewares'   => ['web', 'auth:admin'],
    ...
    */
    ...
    'aliases' => [
        ...
        'AdminColumn'         => Admin\Facades\TableColumn::class,
        'AdminColumnEditable' => Admin\Facades\TableColumnEditable::class,
        'AdminColumnFilter'   => Admin\Facades\TableColumnFilter::class,
        ...
        'AdminFormElement'    => Admin\Facades\FormElement::class,
